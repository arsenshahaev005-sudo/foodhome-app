...
Seller-only new-order sounds require a gated server event, not a renamed generic
order update: [Seller new-order sound 1.7](food-home-seller-order-sound-1.7.md).
